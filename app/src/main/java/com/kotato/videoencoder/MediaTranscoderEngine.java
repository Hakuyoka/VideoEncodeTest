...
import net.ypresto.androidtranscoder.engine.PassThroughTrackTranscoder;
...
public class MediaTranscoderEngine {
    ...
    private net.ypresto.androidtranscoder.engine.MediaTranscoderEngine.ProgressCallback mProgressCallback;
    ...
    public net.ypresto.androidtranscoder.engine.MediaTranscoderEngine.ProgressCallback getProgressCallback() {
        return mProgressCallback;
    }

    public void setProgressCallback(net.ypresto.androidtranscoder.engine.MediaTranscoderEngine.ProgressCallback progressCallback) {
